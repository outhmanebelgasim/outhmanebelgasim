...
**Web development**
Building full-stack web applications with modern frameworks, clean architecture, and attention to performance and user experience.

**DevOps and cloud**
Enthusiast in CI/CD pipelines, Linux server management, infrastructure automation, and cloud-native practices.

**Networking**
Hands-on experience with Cisco networking, GNS3 simulation, and low-level system and network configuration on Linux and Windows.
